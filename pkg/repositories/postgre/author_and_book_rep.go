...
func (a AuthorAndBookPgRep) UpdateBookAndAuthor(ctx context.Context, book *models.Book, author *models.Author) error {
...
func (a AuthorAndBookPgRep) GetAuthorAndBooks(ctx context.Context, id int) (*models.Author, []*models.Book, error) {
